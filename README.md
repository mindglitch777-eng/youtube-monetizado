...
sociales), producido con Claude Code + Pollinations.ai + Edge-TTS + Remotion.
...
2. scripts/generar_imagenes.py → genera las escenas con Pollinations.ai (gratis, sin API key; corre en GitHub Actions)
